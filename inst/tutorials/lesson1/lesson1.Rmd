...
Exercises include a mix of **multiple choice questions (MCQ)** and **R-based questions**. The R-based questions will only cover select topics to keep the focus on *why* and to understand the assumptions and the steps involved.
...
> - Your progress is not saved. User sessions automatically time-out after 10 minutes of inactivity.
...
### Exercise in R: Quantitative Data
...
### Exercise in R: Qualitative Data
