...
You can download and install R from [here](https://cran.r-project.org/).

**RStudio**

RStudio is an application to work with R. It provides an interface to work with R. It is recommended that you install RStudio alongside R.

To download and install Rstudio, follow the instructions [here](https://www.rstudio.com/products/rstudio/download/)

**Reference**

You may find this book chapter *Hands-On Programming with R* by Garett Grolemund useful to help you with the installation process [link](https://rstudio-education.github.io/hopr/starting.html).
...
If you want to add two numbers you can use the command below:

```{r two-plus-two, exercise=TRUE}
1 + 2
```

Test if you can subtract two numbers, say `5` from `8`:
